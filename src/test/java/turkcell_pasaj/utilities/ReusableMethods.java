package turkcell_pasaj.utilities;
...
public class ReusableMethods {
    ...
    //do assertion
    public static void doAssertion(String expectedResult, String actualResult){
        System.out.println("expectedResult = " + expectedResult);
        System.out.println("actualResult = " + actualResult);
        Assert.assertEquals(expectedResult, actualResult);
    }

    public static void doAssertion(int expectedResult, int actualResult){
        Assert.assertEquals(expectedResult, actualResult);
    }
